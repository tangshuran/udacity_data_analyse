...
out.aggregate<-out%>% # here i construct new data frame, both long and wide, for later use
...
ggplot(aes(x=mean_wealth,y=mean_math,color=PARED_cut1,size=n),data=out.aggregate)+
