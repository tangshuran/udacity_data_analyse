...
I choo´sed this data set, because i find that, this dataset has the most variables. I can choose from these variables, and explore more than the other dataset.
...
It shows that, nearly half of the loans are between 1000-5000$.There are only a little amount of loan beyond 25000$.
```{r}
